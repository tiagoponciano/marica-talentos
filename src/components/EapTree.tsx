import { ChevronRight, Circle, FolderTree, Package } from "lucide-react";
  ...
  return (
    <div className="select-none">
      <button
        ...
        className={cn(
          "group flex w-full items-start gap-2 rounded-lg border border-transparent px-3 py-2.5 text-left transition-all",
